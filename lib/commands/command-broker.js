  ...
  module.exports = CommandBroker = (function() {
    ...
    CommandBroker.prototype._initialize = function() {
      ...
      if (this.socket == null) {
        ...
        this.socket.on('data', this._commandReceived);
        ...
        return this.socket.on('end', (function(_this) {
          return function() {
            return _this.dispose();
          };
        })(this));
    ...
    CommandBroker.prototype.dispose = function() {
      var i, j, len, len1, prop, properties, ref, ref1, tx;
      if (this.disposed) {
        return;
      }
...
//# sourceMappingURL=command-broker.js.map
