(function() {
  ...
  module.exports = CommandTransaction = (function() {
    ...
    CommandTransaction.prototype._sendCommand = function(command, data) {
      var deferred, send_;
      console.log("(" + this.consumerId + " - " + this.cid + ") - sendCommand " + command);
      deferred = Q.defer();
    ...
    CommandTransaction.prototype._receiveCommand = function(commandName) {
      var deferred;
      console.log("(" + this.consumerId + " - " + this.cid + ") - receiveCommand " + commandName);
      this._processReceive(commandName);
      deferred = Q.defer();
      this.once('command-received', (function(_this) {
        return function(command) {
          ...
          if (commandName instanceof Array && (ref = command.name, indexOf.call(commandName, ref) >= 0)) {
            ...
            if (((ref1 = command.data) != null ? ref1.errorCode : void 0) === 0) {
              return deferred.resolve(command.data);
            } else {
              return deferred.reject(new DockCommandError(command.data));
            }
          } else {
            return _this._sendCommand('kDResult', {
              errorCode: -28012
            }).then(function() {
...
//# sourceMappingURL=command-transaction.js.map
