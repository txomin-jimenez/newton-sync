...
(function() {
  ...
  module.exports = kDPassword = (function(superClass) {
    ...
    kDPassword.prototype.length = 8;

    function kDPassword() {
      kDPassword.__super__.constructor.apply(this, arguments);
    }

    kDPassword.prototype.dataToBinary = function() {
      var data;
      data = new Buffer(12);
      data.writeUInt32BE(this.length, 0);
      data.writeUInt32BE(this.data.encryptedKey1, 4);
      data.writeUInt32BE(this.data.encryptedKey2, 8);
      return data;
    };
...
//# sourceMappingURL=kDPassword.js.map
