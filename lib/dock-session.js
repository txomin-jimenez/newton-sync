...
(function() {
  ...
  module.exports = DockSession = (function() {
    ...
    DockSession.prototype._negotiatePasswordOld = function() {
      return this.receiveCommand('kDPassword').then((function(_this) {
        return function(receivedKeys) {
          var cipher, encryptedData, keyData, newtonKeys, sendKeys;
          console.log("receivedKeys");
          console.log(receivedKeys);
          newtonKeys = _.pick(_this._newtonInfo, ['encryptedKey1', 'encryptedKey2']);
          ...
          console.log("keyData");
          console.log(keyData);
          cipher = Crypto.createCipheriv("des-ecb", _this.defaultEncryptPass, '');
          cipher.setAutoPadding(false);
          encryptedData = Buffer.concat([cipher.update(keyData), cipher.final()]);
    ...
    DockSession.prototype._initSyncProcess = function() {
      return this.listenForCommand('kDHello', (function(_this) {
        return function() {
