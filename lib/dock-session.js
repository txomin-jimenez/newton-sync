...
(function() {
  var ByteEnum, CommandBroker, CommandConsumer, DockSession, Enum, EventEmitter, NewtonDesCrypto, NewtonDevice, Q, Utils, _;
  ...
  module.exports = DockSession = (function() {
    _.extend(DockSession.prototype, EventEmitter.prototype);
    ...
    function DockSession(options) {
      ...
      this.commandBroker = new CommandBroker({
        socket: this.socket,
        timeout: this.kDefaultTimeout * 1000
      });
      this.sessionTx = this.newCommandTransaction();
    ...
    DockSession.prototype._initialize = function(options) {
      this.commandBroker.on("error", (function(_this) {
        return function(error) {
          _this.emit('error', error);
          return _this.endSession(false);
        };
      })(this));
      this.commandBroker.on("dispose", (function(_this) {
        return function() {
          return _this.endSession(false);
        };
      })(this));
    ...
    DockSession.prototype.initSession = function() {
      return this._initDockSession().then((function(_this) {
        ...
        return function() {
          return _this.sessionTx.sendCommand('kDSetTimeout', _this.kDefaultTimeout);
        };
      })(this)).then((function(_this) {
        return function() {
    ...
    DockSession.prototype._initDockSession = function() {
      return this.sessionTx.receiveCommand('kDRequestToDock').then((function(_this) {
        return function(protocolVersion) {
          var sessionType;
          sessionType = DockSession.sessionTypes.kSynchronizeSession;
          return _this.sessionTx.sendCommand('kDInitiateDocking', {
    ...
    DockSession.prototype._exchangeDevicesInfo = function() {
      var newtonNameInfo;
      newtonNameInfo = null;
      return this.sessionTx.receiveCommand('kDNewtonName').then((function(_this) {
        return function(newtonNameInfo_) {
          newtonNameInfo = newtonNameInfo_;
          return _this.sessionTx.sendCommand('kDDesktopInfo', _this.desktopInfo);
        };
      })(this)).then((function(_this) {
        return function() {
          return _this.sessionTx.receiveCommand('kDNewtonInfo');
        };
      })(this)).then((function(_this) {
        return function(newtonInfo) {
          newtonNameInfo.commandBroker = _this.commandBroker;
    ...
    DockSession.prototype._setDockIcons = function() {
      ...
      return this.sessionTx.sendCommand('kDWhichIcons', whichIcons).then((function(_this) {
        return function() {
          return _this.sessionTx.receiveCommand('kDResult');
        };
      })(this));
    };
    ...
    DockSession.prototype._negotiatePassword = function() {
      return this.sessionTx.receiveCommand('kDPassword').then((function(_this) {
        return function(receivedKey) {
          ...
          if (receivedKey.encryptedKey1 === _this.desktopInfo.encryptedKey1 && _) {
            ...
            return _this.sessionTx.sendCommand('kDPassword', sendKeys).then(function() {
              if (_this.sessionPwd != null) {
                return _this.sessionTx.receiveCommand('kDResult').then(function(pwdResult) {
                  if (pwdResult.errorCode !== 0) {
            ...
            return _this.delay(500).then(function() {
              return _this.sessionTx.sendCommand('kDPWWrong');
            }).then(function() {
              return _this._negotiatePassword();
            });
          }
    ...
    DockSession.prototype._encryptKey = function(newtonKey) {
      var encryptedData, encryptedKey, hexKey, keyData;
      ...
      encryptedData = NewtonDesCrypto.encryptBlock(this.sessionPwd, hexKey);
      encryptedKey = {
    ...
    DockSession.prototype._decryptKey = function(desktopKey) {
      var decryptedData, decryptedKey, hexKey, keyData;
      keyData = new Buffer(8);
      keyData.writeUInt32BE(desktopKey.encryptedKey1, 0);
      keyData.writeUInt32BE(desktopKey.encryptedKey2, 4);
      hexKey = keyData.toString('hex');
      decryptedData = NewtonDesCrypto.decryptBlock(this.sessionPwd, hexKey);
      decryptedKey = {
    ...
    DockSession.prototype.endSession = function(sendDisconnect) {
      var end;
      ...
      if (sendDisconnect) {
        return this.sendCommand('kDDisconnect').then(end);
      } else {
    ...
    DockSession.prototype.dispose = function() {
      ...
      if ((ref = this.commandBroker) != null) {
        ref.dispose();
      }
      if ((ref1 = this.newtonDevice) != null) {
        ref1.dispose();
      }
      properties = ['socket', 'newtonDevice', 'commandBroker', 'sessionTx'];
...
//# sourceMappingURL=dock-session.js.map
