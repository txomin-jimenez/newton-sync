  ...
  module.exports = NewtonDevice = (function() {
    ...
    NewtonDevice.prototype._initStores = function() {
      ...
      return tx.sendCommand('kDGetStoreNames').then(function() {
        ...
        return function() {
          tx = _this.newCommandTransaction();
          return tx.delay(1000);
        };
      })(this)).then(function() {
        return tx.sendCommand('kDOperationDone');
      }).then(function() {
        return tx.delay(1000);
      }).then(function() {
        return tx.finish();
    ...
    NewtonDevice.prototype._initFullSync = function() {
      var tx;
      tx = this.newCommandTransaction();
      return tx.sendCommand('kDGetSyncOptions').then(function() {
        return tx.receiveCommand('kDSyncOptions');
      }).then((function(_this) {
        return function(syncOptions) {
          console.log("received sync options:");
          console.log(syncOptions);
          return tx.sendCommand('kDLastSyncTime');
        };
      })(this)).then(function() {
        return tx.receiveCommand('kDCurrentTime');
      }).then(function(newtonTime) {
    ...
    NewtonDevice.prototype.getSoup = function(soupName) {
      return this.stores['Internal'].getSoup(soupName);
    };
...
//# sourceMappingURL=newton-device.js.map
