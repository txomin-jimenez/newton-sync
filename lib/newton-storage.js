...
(function() {
  var CommandConsumer, EventEmitter, NewtonSoup, NewtonStorage, Q, Utils, _, net;
  ...
  module.exports = NewtonStorage = (function() {
    _.extend(NewtonStorage.prototype, EventEmitter.prototype);
    ...
    NewtonStorage.prototype.getSoup = function(soupName) {
      var tx;
      tx = this.newCommandTransaction();
      return this.setCurrentStore(tx).then((function(_this) {
        return function() {
          tx.finish();
          return _this.soups[soupName];
        };
      })(this));
    };
...
//# sourceMappingURL=newton-storage.js.map
