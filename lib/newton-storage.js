...
(function() {
  ...
  module.exports = NewtonStorage = (function() {
    ...
    NewtonStorage.prototype.initSoups = function() {
      ...
      this.soups = {};
      return this.sendCommand('kDSetStoreGetNames', storeFrame).then((function(_this) {
        return function() {
    ...
    NewtonStorage.prototype.setCurrentStore = function() {
      var storeFrame;
      storeFrame = this.toFrame();
      return this.sendCommand('kDSetCurrentStore', storeFrame).then((function(_this) {
        return function() {
