(function() {
  var NArray, NBinary, NBoolean, NFrame, NImmediate, NKPrecedent, NNIL, NPlainArray, NString, NSymbol, NUniChar, NXlong, NkCharacter, Utils, _, decode, encode;
  ...
  NBinary = {
    ...
    decode: function(buffer, precedents) {
      var binaryClass, binaryData, binaryLength, bytesRead_;
      bytesRead_ = 1;
  ...
  NArray = {
    ...
    decode: function(buffer, precedents) {
      var arrayByteLength, arrayClass, arrayLength, resArray;
      arrayByteLength = 1;
